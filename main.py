...
batch_count = 40
my_batch_size = len(imagePaths_total)//batch_count
...
for batch_idx in range(batch_count):
    ...
    if batch_idx == batch_count - 1:
        imagePaths = imagePaths_total[my_batch_size * batch_idx:]
    else:
        imagePaths = imagePaths_total[my_batch_size * batch_idx: my_batch_size * (batch_idx + 1)]
    ...
    final_percentage = 7
    reduction_percentage = 7   # 중복을 얼만큼 의도적으로 제거할 것인가?
