...
folder = "/hdd1/works/datasets/ssd1/DIV2K_train/original/DIV2K_train_HR"
...
# random_indices = random.sample(range(target_to_group.shape[0]), group_count)
...
for i in range(len(patch_idxs_per_imgs)):
    for j in range(len(patch_idxs_per_imgs[i])):
        #if label_idx in random_indices:
